...
public abstract class PircBot implements ReplyConstants {
    ...
    protected void handleLine(String line) {
        ...
        if (command.equals("PRIVMSG") && line.indexOf(":\u0001") > 0 && line.endsWith("\u0001")) {
        	...
        	this.onWhisper(target, sourceNick, sourceLogin, sourceHostname, line.substring(line.indexOf(" :") + 2));
        }
    ...
    /**
     * This method is called whenever a whisper is sent to a person in a channel.
     *  <p>
     * The implementation of this method in the PircBot abstract class
     * performs no actions and may be overridden as required.
     *
     * @param channel The channel to which the message was sent.
     * @param sender The nick of the person who sent the whisper.
     * @param login The login of the person who sent the whisper.
     * @param hostname The hostname of the person who sent the whisper.
     * @param message The actual whisper.
     */
    protected void onWhisper(String channel, String sender, String login, String hostname, String message) {}
